  ...
  return (
    <div className="flex justify-center items-center">
      <div className="relative">
        <img src="./images/welcomepage-bg.png" className="min-h-screen w-full" alt="bg-welcomePage" />
      </div>
      <div className="absolute font-gofteh w-80 flex justify-center items-center flex-col -mt-20">
        <img src="./images/logo.png" className="w-52" alt="logo" />
        <p className="text-center">لیست کارهایی که قرار تو روز انجام بدی رو بنویس و برنامه ریزی کن تا راحت تر و سریع تر پیش بره کارهات :)</p>
        <Link href="">
          <button className="w-80 mt-10 h-12 bg-[#ffffffaf] flex justify-center items-center gap-2 rounded-md">
            <p>بزن بریم</p>
